...
@section('title', $study->nombreTitulacion . ' - Alumnos')
...
<a href="{{ route('newstudent', $study->idTitulacion) }}" class="btn btn-success btn-sm mb-3">Añadir nuevo</a>
...
@foreach ($users as $s)
  <tr>
      ...
      <td>{{ App\Models\Usuario::getStudentProject($s->user->idUsuario) }}</td>
