...
@section('title', 'Administradores de Centros')
...
<a href="{{ route('newcenteradmin') }}" class="btn btn-success btn-sm mb-3">Añadir nuevo</a>
...
@foreach ($users as $user)
  <tr>
      ...
      <td>{{ $user->user->getCenter($user->user->idUsuario) ? App\Models\Centro::find($user->user->getCenter($user->user->idUsuario))->nombreCentro : "-" }}</td>
